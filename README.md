...
메뉴바
- 버튼 누르면 해당 파이지로 이동(완성)

Already Read
- 책 소개하는 섹션 만들고 규브 돌아가는 느낌 주는 기능(완성)
- 더 보기 버튼 누르면 책 더 보여주는 기능(완성)

Yet to Read
- 화면 왼쪽에 읽고 있는 책 호버하면 책장이 돌아가는 
- 오른쪽에는 가로 스크롤로 읽을 책 나열(변경 리프레시할 때마다 책의 위치가 바뀌는 책장 완성)
- 추천 책을 적는 인풋 칸 만들기(완성)
